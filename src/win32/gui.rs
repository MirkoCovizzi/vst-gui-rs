...
impl WebBrowser {
    ...
    fn new_browser_com_object() -> Result<ComPointer<IWebBrowser2>, Box<Error>> {
    ...
    fn load_html_document(&self, html_document: String) -> Result<(), Box<Error>> {
...
pub fn new_plugin_gui(html_document: String, js_callback: JavascriptCallback) -> Box<PluginGui> {
    Box::new(Gui {
